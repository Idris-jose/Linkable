        ...
        <div className="bg-gradient-to-r from-gray-200 via-white to-white min-h-screen flex flex-col justify-center items-center">
            <div className="absolute top-0 left-0 w-full p-4 flex justify-between items-center" >
             ...
             <div className="flex gap-3 items-center">
               ...
               <button className="bg-gradient-to-r from-blue-700 to-purple-500 via-blue-700 text-white px-4 py-1 rounded hover:bg-blue-600 hover:scale-95 transition-transform duration-200">Get started</button>
